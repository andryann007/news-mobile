...
public class NewsTopHeadlinesAdapter extends RecyclerView.Adapter<NewsTopHeadlinesAdapter.NewsViewHolder> {
    private final List<NewsResult> newsResults;
    private final Context context;

    public NewsTopHeadlinesAdapter(List<NewsResult> newsResults, Context context){
        this.newsResults = newsResults;
        this.context = context;
    }
    @NonNull
    @Override
    public NewsTopHeadlinesAdapter.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NewsViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.container_news, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull NewsTopHeadlinesAdapter.NewsViewHolder holder, int position) {
